...
package isl {
  object Conversions {
    implicit def convertLambdaToVoidCallback1[ArgTy1](f: ArgTy1 => Unit): VoidCallback1[ArgTy1] = {
      new VoidCallback1[ArgTy1]() {
	def apply(arg1: ArgTy1) = f(arg1)
      }
    }

    implicit def convertLambdaToVoidCallback2[ArgTy1,ArgTy2](f: (ArgTy1,ArgTy2) => Unit): VoidCallback2[ArgTy1,ArgTy2] = {
      new VoidCallback2[ArgTy1,ArgTy2]() {
	def apply(arg1: ArgTy1, arg2: ArgTy2) = f(arg1,arg2)
      }
    }

    implicit def convertLambdaToVoidCallback3[ArgTy1,ArgTy2,ArgTy3](f: (ArgTy1,ArgTy2,ArgTy3) => Unit): VoidCallback3[ArgTy1,ArgTy2,ArgTy3] = {
