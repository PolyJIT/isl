...
struct isl_class {
	...
	// method name, only "isl_" is stripped. This is needed for
	// "isl_equality_alloc" and "isl_inequality_alloc" in
	// class "isl_constraint" (see also the list of exceptions
	// to the usual naming scheme at generator::method2class()).
